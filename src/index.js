...
document.getElementById("docist").addEventListener("click", (event) => knihovna.finishCurrentBook());
document.getElementById("zacit").addEventListener("click", (event) => knihovna.startReadingNextBook());
